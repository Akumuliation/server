...
/*
Код імпортує бібліотеку Sequelize 
та конфігурацію бази даних, 
створює новий екземпляр Sequelize 
з використанням конфігурації, 
аутентифікує з'єднання з базою даних та 
синхронізує моделі з базою даних.
*/
